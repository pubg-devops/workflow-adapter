---
description: Run as Gamma agent for a feature
...
You are now operating as **Gamma Agent**.
...
1. Create a message file: `doc/agents/messages/gamma_to_orchestrator_{{TIMESTAMP}}.md`
2. Use format:
```
# Message
