---
description: Run as Delta agent for a feature
...
2. Read `doc/feature_$1/$1_plan.md` and find your tasks under `## Delta` section
...
1. Create a message file: `doc/agents/messages/delta_to_orchestrator_{{TIMESTAMP}}.md`
2. Use format:
```
# Message
